...
<title>web聊天_删除好友</title>
<script type="text/javascript">
<!--
	function sure(name){
		if(confirm('确定删除该好友？')){
			window.location.href = "delfriendProcess.php?f_nickname="+ name;
		}else{
...
<hr/>
<form action="delfriendProcess.php" method="get">
...
<?php
	...
	while($row = mysql_fetch_array($res)){
		...
		echo "<li>".$row['f_nickname']."&nbsp;|&nbsp;<span><input type='button' value='删除好友' onclick='sure(\"$f_nickname\")'/></span></li>";
	}
